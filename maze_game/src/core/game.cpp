...
void Game::resetGame() {
    // 加载选中的地图（map1.txt或map2.txt）
    std::string mapPath = "assets/maps/map" + std::to_string(currentMapIndex + 1) + ".txt";
    ...
    // 生成陷阱
    trapManager.generateTraps(TRAP_COUNT, player, map);
}